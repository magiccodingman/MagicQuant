...
namespace MQ.DB.Migrations
{
    ...
    [Migration("20260503222121_PredictionEngineAnomalyDetect")]
    partial class PredictionEngineAnomalyDetect
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MQ.DB.Models.DbModels.AnomalyInteractionRule", b =>
                {
                    ...
                    b.HasIndex("ArchitectureFamilyId", "TensorGroupProfileId", "AiModelHashId", "ImatrixDefinitionId", "BenchmarkCategory", "ReferenceQuantId", "GroupSetHash", "RuleDirection")
                        .IsUnique();
